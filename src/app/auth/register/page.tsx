        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select 
              ...
              className="w-full p-3 bg-black border border-gray-600 rounded text-white focus:outline-none focus:ring-1 focus:ring-gray-500 disabled:opacity-50"
              disabled={loading}
            >
          ...
          <p className="mt-4 text-center text-gray-400 text-sm">
            Already have an account? <a href="/auth/signin" className="text-gray-400 underline hover:text-gray-300">Sign In</a>
          </p>
